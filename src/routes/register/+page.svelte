...
<div
	class={$darkMode
		? 'flex items-center justify-center bg-main-bg-dark text-text-dark'
		: 'flex items-center justify-center bg-main-bg-light text-text'}
>
	<div class="w-full max-w-md flex flex-col items-center">
		...
		<div
			class={$darkMode
				? 'w-full bg-login-bg-dark shadow-ios rounded-lg p-6'
				: 'w-full bg-login-bg-light shadow-ios rounded-lg p-6'}
		>
			<h1
				class={$darkMode
					? 'text-2xl font-bold mb-4 text-center text-text-dark'
					: 'text-2xl font-bold mb-4 text-center text-text-light'}
			>
				Register
			</h1>
			<form on:submit|preventDefault={handleRegister} class="space-y-4">
				<div>
					...
					<input
						...
						bind:value={email}
						class={$darkMode
							? 'w-full p-2 border rounded-md text-text-light focus:outline-none'
							: 'w-full p-2 border rounded-md text-text-light focus:outline-none focus:ring-1'}
						required
					/>
				</div>
				<div>
				...
				<button
					type="submit"
					class={$darkMode
						? 'w-full py-2 bg-login-btn text-white rounded-md focus:outline-none focus:bg-login-btn-focus'
						: 'w-full py-2 bg-login-btn text-white rounded-md focus:outline-none focus:bg-login-btn-focus'}
				>
					Register
				</button>
