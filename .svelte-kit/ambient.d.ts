...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__firebase_firestore: string;
	...
	export const npm_package_dependencies__types_jwt_decode: string;
	...
	export const npm_package_devDependencies_http_proxy_middleware: string;
	...
	export const npm_package_dependencies__fontsource_roboto_flex: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		INIT_CWD: string;
		_P9K_TTY: string;
		npm_package_dependencies__firebase_firestore: string;
		...
		npm_package_dependencies__types_jwt_decode: string;
		...
		USER_ZDOTDIR: string;
		npm_package_devDependencies_http_proxy_middleware: string;
		PWD: string;
		...
		npm_package_dependencies__fontsource_roboto_flex: string;
