...
<div class={$darkMode ? 'bg-main-bg-dark text-text-dark min-h-screen' : 'bg-main-bg-light text-text min-h-screen'}>
<Header />
...
<footer class="flex flex-col justify-center items-center p-3 sm:p-0">
